...
public class mxGraphHierarchyModel
{
    ...
    for (int i = 0; i < vertices.length; i++)
    {
      ...
      for (Object edge : conns)
      {
        ...
        if (normalizedOtherSide != null)
        {
          ...
          if (list == null)
          {
            outgoingEdgesToSameTargetFromHere.put(normalizedOtherSide, list = new ArrayList<Object>());
          }
  ...
  public void initialRank()
  {
    ...
    while (!startNodes.isEmpty())
    {
      ...
      if (problematicEdges == null)
      {
        problematicEdgesForNode.put(internalNode, problematicEdges = new HashSet<mxGraphHierarchyEdge>());
      }
      ...
      {
        processCounter.put(internalNode, ++count);
      }
